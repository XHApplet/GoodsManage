...
class Ui_MainWidget(object):
    def setupUi(self, MainWidget):
        ...
        self.lineEditOutpuPrice.setAlignment(QtCore.Qt.AlignCenter)
        ...
        MainWidget.setTabOrder(self.comboBoxOutputSeller, self.lineEditOutpuPrice)
        MainWidget.setTabOrder(self.lineEditOutpuPrice, self.lineEditOutputNum)
